...
class ExperimentC {
	...
	Edge e4 = new Edge(2,1,4);
	Edge e5 = new Edge(2,4,14);
	Edge e6 = new Edge(3,2,9);
	Edge e7 = new Edge(3,5,20);
	Edge e8 = new Edge(4,3,7);
	Edge e9 = new Edge(4,5,4);
	Edge[] edges = {e1,e2,e3,e4,e5,e6,e7,e8,e9};
