...
void run_selection() {
  ...
  Sort::selection1(v);
  const Time_point t2 = timing();
  Sort::selection_bi_0(v);
  const Time_point t3 = timing();
  Sort::selection_bi(v);
  const Time_point t4 = timing();
  std::sort(v.begin(),v.end());
  const Time_point t5 = timing();
  std::cout << "s0: " << t1-t0 << "\ts1: " << t2-t1 << "\tbi_0: " << t3-t2 << "\tbi: " << t4-t3
    << "\nstd: " << t5-t4 << std::endl;}
  ...
  std::sort(v.begin(),v.end());
  const Time_point t9 = timing();
  std::cout << "s0: " << t1-t0 << "\ts1: " << t3-t2 << "\tbi_0: " << t5-t4 << "\tbi: " << t7-t6
    << "\nstd: " << t9-t8 << std::endl;}
...
void run_3() {
  ...
  const Time_point t7 = timing();
  for(int a=0;a<loop3;++a){v[0]=a;for(int b=0;b<loop3;++b){v[1]=b;for(int c=0;c<loop3;++c) {v[2]=c; Sort::selection_bi_0(v);}}}
  const Time_point t8 = timing();
  ...
  std::cout << "i0: " << t1-t0 << "\ti1: " << t2-t1 << "\ti2: " << t3-t2
    << "\ti3: " << t4-t3 << "\ti: " << t5-t4
    << "\ns0: " << t6-t5 << "\ts1: " << t7-t6 << "\tbi_0: " << t8-t7 << "\tbi: " << t9-t8
    << "\n_3: " << t10-t9 << "\t_3_: " << t11-t10
    << "\nstd: " << t12-t11 << std::endl;
}
...
void run_4() {
  ...
  const Time_point t7 = timing();
  for(int a=0;a<loop4;++a){v[0]=a;for(int b=0;b<loop4;++b){v[1]=b;for(int c=0;c<loop4;++c){v[2]=c;for(int d=0;d<loop4;++d) {v[3]=d; Sort::selection_bi_0(v);}}}}
  const Time_point t8 = timing();
...
void run_7() {
  ...
  const Time_point t7 = timing();
  for(int a=0;a<loop7;++a){v[0]=a;for(int b=0;b<loop7;++b){v[1]=b;for(int c=0;c<loop7;++c){v[2]=c;for(int d=0;d<loop7;++d){v[3]=d;for(int e=0;e<loop7;++e){v[4]=e;for(int f=0;f<loop7;++f){v[5]=f;for(int g=0;g<loop7;++g){v[6]=g; Sort::selection_bi_0(v);}}}}}}}
  const Time_point t8 = timing();
